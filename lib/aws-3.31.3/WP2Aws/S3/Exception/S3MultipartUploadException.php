<?php
namespace WP2Aws\S3\Exception;

use WP2Aws\CommandInterface;
use WP2Aws\Exception\WP2AwsException;
use WP2Aws\Multipart\UploadState;

class S3MultipartUploadException extends \WP2Aws\Exception\MultipartUploadException
{
     ...
     *                                WP2AwsExceptions being thrown when uploading parts
     *                                for one object, or an instance of WP2AwsException
