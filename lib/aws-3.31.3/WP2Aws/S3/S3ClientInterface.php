...
interface S3ClientInterface extends WP2AwsClientInterface
{
    /**
     ...
     * use the {@see \WP2Aws\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options WP2Aws\S3\BatchDelete options array.
     *
     * @see WP2Aws\S3\S3Client::listObjects
     ...
     *   function signature like `function (WP2Aws\Command $command) {...}`.
     ...
     *
     * @see WP2Aws\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see WP2Aws\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in WP2Aws\S3\Transfer::__construct
     *
     * @see WP2Aws\S3\Transfer for more options and customization
     */
