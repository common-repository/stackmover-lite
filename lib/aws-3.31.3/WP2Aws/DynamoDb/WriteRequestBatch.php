...
class WriteRequestBatch
{
     ...
     *       It should accept an \WP2Aws\CommandInterface object as its argument.
     *     - error: Executed if an error was encountered executing a,
     *       BatchWriteItem operation, otherwise errors are ignored. It should
     *       accept an \WP2Aws\Exception\WP2AwsException as its argument.
     *
        ...
        while ($this->queue && $keepFlushing) {
            ...
            $pool = new CommandPool($this->client, $commands, [
                ...
                'rejected' => function ($reason) {
                    if ($reason instanceof WP2AwsException) {
                        $code = $reason->getWP2AwsErrorCode();
