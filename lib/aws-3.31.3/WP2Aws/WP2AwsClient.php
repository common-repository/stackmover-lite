 ...
 */
class WP2AwsClient implements WP2AwsClientInterface
{
    use WP2AwsClientTrait;
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (WP2Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   WP2Aws\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See WP2Aws\Credentials\CredentialProvider for
     ...
     *   WP2GuzzleHttp\TransferStats). HTTP handlers must support an
     ...
     *   is required. See WP2Aws\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   WP2Aws\ResultInterface object or rejected with an
     *   WP2Aws\Exception\WP2AwsException. A handler does not accept a next handler
     ...
     *   WP2Aws\Signature\SignatureProvider for a list of built-in providers
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'WP2Aws\Exception\WP2AwsException'];
        }
        ...
        return [
            strtolower($service),
            "WP2Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
