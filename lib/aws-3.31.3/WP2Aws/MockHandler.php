 ...
 * WP2Aws\ResultInterface and WP2Aws\Exception\WP2AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see WP2Aws\ResultInterface} or
     * {@see WP2AwsException} objects that acts as a queue of results or
    ...
    /**
     * Adds one or more variadic ResultInterface or WP2AwsException objects to the
     * queue.
     */
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                || $value instanceof WP2AwsException
                || is_callable($value)
            ) {
                $this->queue[] = $value;
            } else {
                throw new \InvalidArgumentException('Expected an WP2Aws\ResultInterface or WP2Aws\Exception\WP2AwsException.');
            }
        }
    }
