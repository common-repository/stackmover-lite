...
{
    /** @var WP2AwsClientInterface Client performing operations. */
    private $client;
    ...
    /**
     * @param WP2AwsClientInterface $client
     ...
     *
     * The callback should have the signature: function (WP2Aws\Result $result).
