<?php
namespace WP2Aws\Multipart;

use WP2Aws\WP2AwsClientInterface as Client;
use WP2Aws\CommandInterface;
use WP2Aws\CommandPool;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = [
        ...
        'exception_class' => 'WP2Aws\Exception\MultipartUploadException',
    ];
    ...
    public function promise()
    {
        ...
        return $this->promise = Promise\coroutine(function () {
            ...
            if ($e instanceof WP2AwsException) {
        ...
        return function (callable $handler) use (&$errors) {
            return function (
                ...
                return $handler($command, $request)->then(
                    ...
                    function (WP2AwsException $e) use (&$errors) {
