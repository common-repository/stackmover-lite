 ...
 * promise that is fulfilled with an {@see \WP2Aws\Credentials\CredentialsInterface}
 * or rejected with an {@see \WP2Aws\Exception\CredentialsException}.
 *
 * <code>
 ...
 * {@see WP2Aws\Credentials\CredentialProvider::chain}. This function accepts
...
class CredentialProvider
{
     ...
     * instance of WP2Aws\CacheInterface. Forwards calls when no credentials found
     ...
     * @see WP2Aws\Credentials\InstanceProfileProvider for $config details.
     */
     ...
     * @see WP2Aws\Credentials\EcsCredentialProvider for $config details.
     */
     ...
     * @param array $config Array of configuration data
     * @return callable
     * @see WP2Aws\Credentials\AssumeRoleCredentialProvider for $config details.
     */
