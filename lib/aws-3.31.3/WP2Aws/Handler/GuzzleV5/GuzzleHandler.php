...
use WP2Aws\Sdk;
use Exception;
use WP2GuzzleHttp\Client;
use WP2GuzzleHttp\ClientInterface;
use WP2GuzzleHttp\Event\EndEvent;
use WP2GuzzleHttp\Exception\ConnectException;
use WP2GuzzleHttp\Exception\RequestException;
use WP2GuzzleHttp\Message\ResponseInterface as GuzzleResponse;
use WP2GuzzleHttp\Promise;
use WP2GuzzleHttp\Psr7\Response as Psr7Response;
