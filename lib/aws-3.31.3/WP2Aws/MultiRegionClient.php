...
use WP2Aws\Endpoint\PartitionInterface;
use WP2GuzzleHttp\Promise\FulfilledPromise;
use Psr\Http\Message\RequestInterface;

class MultiRegionClient implements WP2AwsClientInterface
{
    use WP2AwsClientTrait;

    /** @var WP2AwsClientInterface[] A pool of clients keyed by region. */
    private $clientPool = [];
    /** @var callable */
    private $factory;
        ...
        return $args + [
            'client_factory' => [
                ...
                'default' => function (array $args) {
                    ...
                    $klass = "WP2Aws\\{$namespace}\\{$namespace}Client";
     ...
     * - partition: (WP2Aws\Endpoint\Partition|string) AWS partition to connect to.
