<?php
namespace WP2Aws\Sqs;

use WP2Aws\WP2AwsClient;
use WP2Aws\CommandInterface;
use WP2Aws\Sqs\Exception\SqsException;
use WP2GuzzleHttp\Psr7\Uri;
use WP2GuzzleHttp\Psr7\UriResolver;
 ...
 * @method \WP2Aws\Result changeMessageVisibility(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise changeMessageVisibilityAsync(array $args = [])
 * @method \WP2Aws\Result changeMessageVisibilityBatch(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise changeMessageVisibilityBatchAsync(array $args = [])
 * @method \WP2Aws\Result createQueue(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise createQueueAsync(array $args = [])
 * @method \WP2Aws\Result deleteMessage(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise deleteMessageAsync(array $args = [])
 * @method \WP2Aws\Result deleteMessageBatch(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise deleteMessageBatchAsync(array $args = [])
 * @method \WP2Aws\Result deleteQueue(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise deleteQueueAsync(array $args = [])
 * @method \WP2Aws\Result getQueueAttributes(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise getQueueAttributesAsync(array $args = [])
 * @method \WP2Aws\Result getQueueUrl(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise getQueueUrlAsync(array $args = [])
 * @method \WP2Aws\Result listDeadLetterSourceQueues(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise listDeadLetterSourceQueuesAsync(array $args = [])
 * @method \WP2Aws\Result listQueues(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise listQueuesAsync(array $args = [])
 * @method \WP2Aws\Result purgeQueue(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise purgeQueueAsync(array $args = [])
 * @method \WP2Aws\Result receiveMessage(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise receiveMessageAsync(array $args = [])
 * @method \WP2Aws\Result removePermission(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise removePermissionAsync(array $args = [])
 * @method \WP2Aws\Result sendMessage(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise sendMessageAsync(array $args = [])
 * @method \WP2Aws\Result sendMessageBatch(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise sendMessageBatchAsync(array $args = [])
 * @method \WP2Aws\Result setQueueAttributes(array $args = [])
 * @method \WP2GuzzleHttp\Promise\Promise setQueueAttributesAsync(array $args = [])
 */
class SqsClient extends WP2AwsClient
{
