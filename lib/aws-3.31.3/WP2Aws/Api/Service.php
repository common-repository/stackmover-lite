...
use WP2Aws\Api\Serializer\QuerySerializer;
use WP2Aws\Api\Serializer\Ec2ParamBuilder;
use WP2Aws\Api\Parser\QueryParser;
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = [
            'json'      => 'WP2Aws\Api\Serializer\JsonRpcSerializer',
            'query'     => 'WP2Aws\Api\Serializer\QuerySerializer',
            'rest-json' => 'WP2Aws\Api\Serializer\RestJsonSerializer',
            'rest-xml'  => 'WP2Aws\Api\Serializer\RestXmlSerializer'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WP2Aws\Api\ErrorParser\JsonRpcErrorParser',
            'query'     => 'WP2Aws\Api\ErrorParser\XmlErrorParser',
            'rest-json' => 'WP2Aws\Api\ErrorParser\RestJsonErrorParser',
            'rest-xml'  => 'WP2Aws\Api\ErrorParser\XmlErrorParser',
            'ec2'       => 'WP2Aws\Api\ErrorParser\XmlErrorParser'
        ];
    ...
    {
        static $mapping = [
            'json'      => 'WP2Aws\Api\Parser\JsonRpcParser',
            'query'     => 'WP2Aws\Api\Parser\QueryParser',
            'rest-json' => 'WP2Aws\Api\Parser\RestJsonParser',
            'rest-xml'  => 'WP2Aws\Api\Parser\RestXmlParser'
        ];
