...
use WP2Aws\Exception\UnresolvedApiException;
 ...
 * {@see WP2Aws\Exception\UnresolvedApiException}.
 *
 ...
 * {@see WP2Aws\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \WP2Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \WP2Aws\load_compiled_json($path);
